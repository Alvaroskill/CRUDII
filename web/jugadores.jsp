...
<html>
  ...
  <body id="jugadores">
      ...
      ResultSet resultado = s.executeQuery ("SELECT * FROM equipos WHERE CodUsu=" + session.getAttribute("codigo"));
      try{
    %>
...
<p>Datos personales:</p>
    <form name="form" method="get" action="insertarJugadores.jsp" onsubmit="return validar()">
      <label>Codigo <input type="text" name="numeroID"/></label><br/>
